...
describe('controller', function () {
	...
	var setUpModel = function (todos) {
		model.read.and.callFake(function (query, callback) {
			...
			callback(todos);
            console.log("setUpModel -> todos", todos)
		...
		model.getCount.and.callFake(function (callback) {
			...
			console.log("setUpModel -> active", todoCounts.active)
			console.log("setUpModel -> completed", todoCounts.completed)
			console.log("setUpModel -> total", todoCounts.total)
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			...
			expect(model.update).toHaveBeenCalledWith(1987, {completed: true}, jasmine.any(Function))
			expect(model.update).toHaveBeenCalledWith(2019, {completed: true}, jasmine.any(Function))
			// TODO: write test
		});
		...
		it('should update the view', function () {
			...
			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 1987, completed: false});
